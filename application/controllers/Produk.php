...
class Produk extends CI_Controller
{
    ...
    public function createTab()
    {
        ...
        $this->form_validation->set_rules('no_ahli_waris', 'No. Hp Ahli Waris', 'required|trim');
        $this->form_validation->set_rules('status_menikah', 'Status Pernikahan', 'required|trim');
        ...
        $this->form_validation->set_rules('status_pekerjaan', 'Status Pekerjaan', 'required|trim');
        $this->form_validation->set_rules('sumber_dana', 'Sumber Penghasilan', 'required|trim');
        $this->form_validation->set_rules('status_rumah', 'Status Tempat Tinggal', 'required|trim');
        $this->form_validation->set_rules('status_rumah', 'Status Tempat Tinggal', 'required|trim');
        $this->form_validation->set_rules('tanggungan', 'Tanggungan', 'required|trim');
        $this->form_validation->set_rules('tujuan_buka', 'Tujuan Pembukaan', 'required|trim');
        $this->form_validation->set_rules('jenis_tab', 'Jenis Tabungan', 'required|trim');
        ...
        $this->form_validation->set_rules('ft_npwp', 'Foto NPWP', 'required|trim');
