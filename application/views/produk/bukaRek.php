    ...
    <div class="container">
        <div class="row">
            ...
            <div class="form-group">
                <input type="text" class="form-control form-control-user" name="produk" id="produk" placeholder="Nama Lengkap" value="<?= set_value('produk'); ?>">
            ...
            <div class="scroll" style="overflow:scroll;width:70%;height:200px;text-align:justify;">
