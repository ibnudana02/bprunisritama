                ...
                <div class="row">
                    ...
                    <div class=" col-md-6 col-sm-6">
                        <div class="topbar-right">
                            <ul>
                                <li><a href="#"><i class="fa fa-envelope"></i> info@mentose.com</a></li>
                                    ...
                                    <ul class="nav navbar-nav navbar-right">
                                        <li><a class="pagess" href="index.html">Home</a>
                                            <ul class="sub-menu">
                                                ...
                                                <li class="dropdown dropdown-menu"><a href="index-4.html">Home 04</a>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-12">
                                        <!-- layer 1 -->
                                        <div class="layer-1-2">
                                            <h1 class="title2">The Most <span class="color">Prestigious</span> Consulting Firm</h1>
                                        </div>
                                        <!-- layer 2 -->
                                        <div class="layer-1-1">
                                            <p>A consulting or consultancy firm is a business of one or more experts that provides professional advice.</p>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="well-services">
                        <div class="services-img">
                            <img src="<?php echo base_url('assets/'); ?>img/service/1.jpg" alt="">
                            <span class="top-icon"><i class="flaticon-graph-6"></i></span>
                            <div class="image-layer">
                                <a href="#"><i class="flaticon-graph-8"></i>business analytics</a>
                                <a href="#"><i class="flaticon-graph-3"></i>Digital growth</a>
                                <a href="#"><i class="flaticon-notes-2"></i>Investment plan</a>
                                <a href="#"><i class="flaticon-investment"></i>Complete achivment</a>
                            </div>
                        </div>
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="well-services">
                        <div class="services-img">
                            <img src="<?php echo base_url('assets/'); ?>img/service/2.jpg" alt="">
                            <span class="top-icon"><i class="flaticon-graph"></i></span>
                            <div class="image-layer">
                                <a href="#"><i class="flaticon-grocery"></i>Targeted country</a>
                                <a href="#"><i class="flaticon-diagram-1"></i>Digital production</a>
                                <a href="#"><i class="flaticon-presentation-3"></i>Intergated campaign</a>
                                <a href="#"><i class="flaticon-rewind-time"></i>Event activation</a>
                            </div>
                        </div>
                        <div class="main-services">
                            <div class="service-content">
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="well-services">
                        <div class="services-img">
                            <img src="<?php echo base_url('assets/'); ?>img/service/3.jpg" alt="">
                            <span class="top-icon"><i class="flaticon-notes"></i></span>
                            <div class="image-layer">
                                <a href="#"><i class="flaticon-change"></i>Bank investment plan</a>
                                <a href="#"><i class="flaticon-graph-7"></i>Business planning</a>
                                <a href="#"><i class="flaticon-suitcase"></i>success your business</a>
                                <a href="#"><i class="flaticon-time-is-money"></i>Extra facilities</a>
                            </div>
                        </div>
                        <div class="main-services">
                            <div class="service-content">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="about-image">
                        <img src="<?php echo base_url('assets/'); ?>img/about/ab.jpg" alt="">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="single-services">
                            <div class="service-inner">
                                ...
                                <div class="service-content">
                                    <h4><a href="#">Marketing research</a></h4>
                                    <p>Our independent consultants, free from the internal demands of traditional firms, can focus.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="single-services">
                            <div class="service-inner">
                                ...
                                <div class="service-content">
                                    <h4><a href="#">Consumer markets</a></h4>
                                    <p>Our independent consultants, free from the internal demands of traditional firms, can focus.</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="project-carousel">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="single-awesome-project">
                            <div class="awesome-img">
                                <a href="#">
                                    <img src="<?php echo base_url('assets/'); ?>img/project/1.jpg" alt="" />
                                </a>
                                <div class="add-actions text-center">
                                    <a class="venobox" data-gall="myGallery" href="<?php echo base_url('assets/'); ?>img/project/1.jpg">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        ...
                        <div class="single-awesome-project">
                            <div class="awesome-img">
                                <a href="#">
                                    <img src="<?php echo base_url('assets/'); ?>img/project/2.jpg" alt="" />
                                </a>
                                <div class="add-actions text-center">
                                    <a class="venobox" data-gall="myGallery" href="<?php echo base_url('assets/'); ?>img/project/2.jpg">
                                        <i class="port-icon icon icon-picture"></i>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        ...
                        <div class="single-awesome-project">
                            <div class="awesome-img">
                                <a href="#">
                                    <img src="<?php echo base_url('assets/'); ?>img/project/3.jpg" alt="" />
                                </a>
                                <div class="add-actions text-center">
                                    <a class="venobox" data-gall="myGallery" href="<?php echo base_url('assets/'); ?>img/project/3.jpg">
                                        <i class="port-icon icon icon-picture"></i>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        ...
                        <div class="single-awesome-project">
                            <div class="awesome-img">
                                <a href="#">
                                    <img src="<?php echo base_url('assets/'); ?>img/project/4.jpg" alt="" />
                                </a>
                                <div class="add-actions text-center">
                                    <a class="venobox" data-gall="myGallery" href="<?php echo base_url('assets/'); ?>img/project/4.jpg">
                                        <i class="port-icon icon icon-picture"></i>
                                    </a>
                                </div>
                            </div>
                            <div class="project-dec">
                                <h4>Envernment project</h4>
                                <p>Our development opt in to the projects they genuinely want to work on, committing wholeheartedly to delivering.</p>
                            </div>
                        </div>
                        <!-- single-awesome-project end -->
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        ...
                        <div class="single-awesome-project">
                            <div class="awesome-img">
                                <a href="#">
                                    <img src="<?php echo base_url('assets/'); ?>img/project/5.jpg" alt="" />
                                </a>
                                <div class="add-actions text-center">
                                    <a class="venobox" data-gall="myGallery" href="<?php echo base_url('assets/'); ?>img/project/5.jpg">
                                        <i class="port-icon icon icon-picture"></i>
                                    </a>
                                </div>
                            </div>
                            <div class="project-dec">
                                <h4>Electrical project</h4>
                                <p>Our development opt in to the projects they genuinely want to work on, committing wholeheartedly to delivering.</p>
                            </div>
                        </div>
                        <!-- single-awesome-project end -->
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        ...
                        <div class="single-awesome-project">
                            <div class="awesome-img">
                                <a href="#">
                                    <img src="<?php echo base_url('assets/'); ?>img/project/6.jpg" alt="" />
                                </a>
                                <div class="add-actions text-center">
                                    <a class="venobox" data-gall="myGallery" href="<?php echo base_url('assets/'); ?>img/project/6.jpg">
                                        <i class="port-icon icon icon-picture"></i>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="banner-text text-center">
                            ...
                            <div class="brand-items">
                                <div class="single-brand-item">
                                    <a href="#"><img src="<?php echo base_url('assets/'); ?>img/client/1.png" alt=""></a>
                                </div>
                                <div class="single-brand-item">
                                    <a href="#"><img src="<?php echo base_url('assets/'); ?>img/client/2.png" alt=""></a>
                                </div>
                                <div class="single-brand-item">
                                    <a href="#"><img src="<?php echo base_url('assets/'); ?>img/client/3.png" alt=""></a>
                                </div>
                                <div class="single-brand-item">
                                    <a href="#"><img src="<?php echo base_url('assets/'); ?>img/client/4.png" alt=""></a>
                                </div>
                                <div class="single-brand-item">
                                    <a href="#"><img src="<?php echo base_url('assets/'); ?>img/client/5.png" alt=""></a>
                                </div>
                                <div class="single-brand-item">
                                    <a href="#"><img src="<?php echo base_url('assets/'); ?>img/client/6.png" alt=""></a>
                                </div>
                                <div class="single-brand-item">
                                    <a href="#"><img src="<?php echo base_url('assets/'); ?>img/client/7.png" alt=""></a>
                                </div>
                                <div class="single-brand-item">
                                    <a href="#"><img src="<?php echo base_url('assets/'); ?>img/client/8.png" alt=""></a>
                                </div>
                                <div class="single-brand-item">
                                    <a href="#"><img src="<?php echo base_url('assets/'); ?>img/client/9.png" alt=""></a>
                                </div>
                                <div class="single-brand-item">
                                    <a href="#"><img src="<?php echo base_url('assets/'); ?>img/client/10.png" alt=""></a>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="overview-inner">
                        ...
                        <h4>Mentos consultant firm worldwide serving 500+ clients and globally with us 5500+ <span class="color">international consultants</span></h4>
                        <p>
            ...
            <div class="row">
                ...
                <div class="col-md-5 col-sm-12 col-xs-12">
                    <div class="faq-content">
                        ...
                        <div class="faq-quote">
                            <div class="row">
                                <form id="contactForm" method="POST" action="http://rockstheme.com/rocks/preview-mentos/contact.php" class="contact-form">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="add-content">
                        ...
                        <div class="add-contact">
                            ...
                            <span class="call-us mail-us"><i class="icon icon-envelope"></i>Mail us : mentos-09@mail.com</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="blog-grid home-blog">
                        ...
                        <div class="single-blog">
                            <div class="blog-image">
                                <a class="image-scale" href="#">
                                    <img src="<?php echo base_url('assets/'); ?>img/blog/b1.jpg" alt="">
                                </a>
                            </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="single-blog">
                            <div class="blog-image">
                                <a class="image-scale" href="#">
                                    <img src="<?php echo base_url('assets/'); ?>img/blog/b2.jpg" alt="">
                                </a>
                            </div>
                            <div class="blog-content">
                                <div class="blog-category">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="single-blog">
                            <div class="blog-image">
                                <a class="image-scale" href="#">
                                    <img src="<?php echo base_url('assets/'); ?>img/blog/b3.jpg" alt="">
                                </a>
                            </div>
                            <div class="blog-content">
                                <div class="blog-category">
                    ...
                    <div class="hidden-md hidden-lg col-sm-6 col-xs-12">
                        <div class="single-blog">
                            <div class="blog-image">
                                <a class="image-scale" href="#">
                                    <img src="<?php echo base_url('assets/'); ?>img/blog/b4.jpg" alt="">
                                </a>
                            </div>
                            <div class="blog-content">
                                <div class="blog-category">
